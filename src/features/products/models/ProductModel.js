class ProductModel {
  constructor(data) {
    ...
    this.price = priceValue !== undefined && priceValue !== null ? 
      parseFloat(priceValue) : 0;
      
    this.material_type = data.type_matiere || data.material_type;
    ...
    this.updated_at = data.derniere_mise_a_jour ? new Date(data.derniere_mise_a_jour) : null;
    ...
    this.type_matiere = data.type_matiere || data.material_type;
