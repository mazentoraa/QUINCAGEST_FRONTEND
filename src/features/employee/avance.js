  ...
  <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
    <div
      style={{
        ...
        height: "48px",
        borderRadius: "16px",
        background: "linear-gradient(135deg, #52c41a 0%, #7ed957 100%)",
        boxShadow: "0 6px 20px rgba(82, 196, 26, 0.25)",
        position: "relative",
      }}
    >
      <DollarOutlined style={{ fontSize: "24px", color: "#ffffff" }} />
      <div
        style={{
          position: "absolute",
          top: "-2px",
    ...
    <div>
      ...
      >
        {employees.length} avance{employees.length !== 1 ? "s" : ""} enregistré
